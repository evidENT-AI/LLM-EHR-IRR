...
Example:
    ...
    processor = BatchLetterProcessor(
        anthropic_key=DEFAULT_API_KEY,
        base_output_dir=base_output_dir
    )
    
    # Run batch processing
    models = [CLAUDE_MODELS['CLAUDE_HAIKU']]
...
Note:
    ...
    a valid Anthropic API key for operation.
...
from labeller import ClaudeInstance
from config import (
...
def main():
    ...
    # Models to test
    models = [CLAUDE_MODELS['CLAUDE_SONNET_35']]
